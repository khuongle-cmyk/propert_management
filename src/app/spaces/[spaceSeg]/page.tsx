...
export default async function RootSpaceSegmentPage({
  params,
  searchParams,
}: {
  ...
  if (prop) {
    ...
    return (
      <Cms2SiteChrome org={org} basePath="" locale={locale} ui={ui}>
        <Cms2PropertyDetail org={org} theme={t} basePath="" locale={locale} ui={ui} group={prop} typeFilter={typeFilter} />
      </Cms2SiteChrome>
    );
  }
